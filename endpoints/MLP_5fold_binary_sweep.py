...
from model.MLP import MLP, MLP_binary
...
def main():
    ...
    save_path='./results/{}/sweep_binary/MLP_batch-{}_lr-{}_encoder-{}_layer-{}_hidden_c-{}_threshold-{}/'.format(protein,batch_size,lr,encoder,layer,hidden_c,threshold)
    ...
    es_checkpoint_path='./results/{}/sweep_binary/MLP_batch-{}_lr-{}_encoder-{}_layer-{}_hidden_c-{}_threshold-{}/'.format(protein,batch_size,lr,encoder,layer,hidden_c,threshold)
    ...
    for fold in range(kfold):
        ...
        model = MLP_binary(input_dim=input_dim, hidden_channels=hidden_channels, output_dim=1, dropout_rate=0.2, batch_norm=False)
