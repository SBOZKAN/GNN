...
def main():
    ...
    save_path='./results/{}/sweep/CNN_batch-{}_encoder-{}_layer-{}_hidden_c-{}_kernel-{}_stride-{}/'.format(protein,batch_size,encoder,layer,hidden_c,kernel,stride)
    ...
    es_checkpoint_path='./results/{}/sweep/CNN_batch-{}_encoder-{}_layer-{}_hidden_c-{}_kernel-{}_stride-{}/'.format(protein,batch_size,encoder,layer,hidden_c,kernel,stride)
