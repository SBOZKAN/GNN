...
def main():
    ...
    save_path='./results/{}/sweep/MLP_batch-{}_lr-{}_encoder-{}_layer-{}_hidden_c-{}/'.format(protein,batch_size,lr,encoder,layer,hidden_c)
    ...
    es_checkpoint_path='./results/{}/sweep/MLP_batch-{}_lr-{}_encoder-{}_layer-{}_hidden_c-{}/'.format(protein,batch_size,lr,encoder,layer,hidden_c)
    ...
    for fold in range(kfold):
        ...
        model = MLP(input_dim=input_dim, hidden_channels=hidden_channels, output_dim=1, dropout_rate=0.2, batch_norm=False)
