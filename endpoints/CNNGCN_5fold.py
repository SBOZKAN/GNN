...
def main():
    ...
    save_path='./results/{}/5fold/CNNGCN_{}_{}_{}_{}/'.format(protein,hidden_channels_CNN,hidden_channels_GNN,n_type,cut_off)
    ...
    es_checkpoint_path='./results/{}/5fold/CNNGCN_{}_{}_{}_{}/'.format(protein,hidden_channels_CNN,hidden_channels_GNN,n_type,cut_off)
    
    if n_type in ['pctdci_asym', 'dci_asym']:
        save_path='./results/{}/5fold/CNNGCN_{}_{}_{}_{}_{}_{}/'.format(protein,hidden_channels_CNN,hidden_channels_GNN,n_type,cut_off,c_type,high_couple)
        es_checkpoint_path='./results/{}/5fold/CNNGCN_{}_{}_{}_{}_{}_{}/'.format(protein,hidden_channels_CNN,hidden_channels_GNN,n_type,cut_off,c_type,high_couple)
