...
def main():
    ...
    save_path='./results/{}/5fold/GCN_{}_{}_{}/'.format(protein,hidden_channels,n_type,cut_off)
    ...
    es_checkpoint_path='./results/{}/5fold/GCN_{}_{}_{}/'.format(protein,hidden_channels,n_type,cut_off)
    
    if n_type in ['pctdci_asym', 'dci_asym']:
        save_path='./results/{}/5fold/GCN_{}_{}_{}_{}_{}/'.format(protein,hidden_channels,n_type,cut_off,c_type,high_couple)
        es_checkpoint_path='./results/{}/5fold/GCN_{}_{}_{}_{}_{}/'.format(protein,hidden_channels,n_type,cut_off,c_type,high_couple)
    ...
    for fold in range(kfold):
        ...
        model = GCN(input_dim=40,num_node=X_train.shape[-2],hidden_channels_GNN=hidden_channels,hidden_channels_MLP=100,output_dim=1)
