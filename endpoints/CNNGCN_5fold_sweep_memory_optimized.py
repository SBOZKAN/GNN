...
from model.CNNGCN import CNNGCN
...
def main():
   ...
   # encoder='one_hot,aa_index' # can be change when new encoder finished
    ...
    save_path='./results/{}/sweep/CNNGCN_{}_{}_batch-{}_encoder-{}_clayer-{}_chidden_c-{}_kernel-{}_stride-{}_glayer-{}_ghidden_c-{}/'.format(protein,n_type,cut_off,batch_size,encoder,c_layer,c_hidden_c,kernel,stride,g_layer,g_hidden_c)
    ...
    es_checkpoint_path='./results/{}/sweep/CNNGCN_{}_{}_batch-{}_encoder-{}_clayer-{}_chidden_c-{}_kernel-{}_stride-{}_glayer-{}_ghidden_c-{}/'.format(protein,n_type,cut_off,batch_size,encoder,c_layer,c_hidden_c,kernel,stride,g_layer,g_hidden_c)
    
    if n_type in ['pctdci_asym', 'dci_asym']:
        save_path='./results/{}/sweep/CNNGCN_{}_{}_{}_{}_batch-{}_encoder-{}_clayer-{}_chidden_c-{}_kernel-{}_stride-{}_glayer-{}_ghidden_c-{}/'.format(protein,n_type,cut_off,c_type,high_couple,batch_size,encoder,c_layer,c_hidden_c,kernel,stride,g_layer,g_hidden_c)
        es_checkpoint_path='./results/{}/sweep/CNNGCN_{}_{}_{}_{}_batch-{}_encoder-{}_clayer-{}_chidden_c-{}_kernel-{}_stride-{}_glayer-{}_ghidden_c-{}/'.format(protein,n_type,cut_off,c_type,high_couple,batch_size,encoder,c_layer,c_hidden_c,kernel,stride,g_layer,g_hidden_c)
    ...
    for fold in range(kfold):
        ...
        # delete some variable to save memory for the test process
        del train, valid, y_train, y_valid, seq_train, seq_valid, X_train, X_valid
        ...
        test_data=list(zip(seq_test,y_test))
        ...
        for data in test_loader:
            x,y = data
            x=enc.encode(encoding=encoder, char_seqs=list(x))   # encode seqs of test protein
            x=torch.Tensor(x)
            y=torch.Tensor(y)
            x=x.to(device)
            y=y.to(device)
        ...
        # delete some variable to save memory for the test process
        del test, y_test, seq_test, test_loader, y_pred, pred_data
        _=gc.collect()
