...
def main():
    ...
    device='cuda'
    hidden_channels=[100]
    hidden_channels_CNN=[128,128,128]
    dropout_rate=0.5
    ...
    save_path='./results/{}/5fold/CNN_{}/'.format(protein,hidden_channels_CNN)
    ...
    es_checkpoint_path='./results/{}/5fold/CNN_{}/'.format(protein,hidden_channels_CNN)
